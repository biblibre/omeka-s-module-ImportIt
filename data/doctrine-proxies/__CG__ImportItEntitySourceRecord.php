...
namespace DoctrineProxies\__CG__\ImportIt\Entity;


/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class SourceRecord extends \ImportIt\Entity\SourceRecord implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'source', 'externalId', 'entityClass', 'entityId'];
        }
     ...
     * {@inheritDoc}
     */
    public function getSource(): \ImportIt\Entity\Source
    {
     ...
     * {@inheritDoc}
     */
    public function setSource(\ImportIt\Entity\Source $source)
    {
